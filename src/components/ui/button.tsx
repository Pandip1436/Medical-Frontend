  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        brand:
          "bg-brand text-brand-foreground shadow-sm shadow-brand/25 hover:bg-brand/90 hover:shadow-md hover:shadow-brand/30",
        destructive:
        ...
        success:
          "bg-emerald-600 text-white shadow-sm shadow-emerald-600/25 hover:bg-emerald-700 hover:shadow-md hover:shadow-emerald-600/30 dark:bg-emerald-600 dark:hover:bg-emerald-500",
        warning:
          "bg-amber-500 text-white shadow-sm shadow-amber-500/25 hover:bg-amber-600 hover:shadow-md hover:shadow-amber-500/30 dark:bg-amber-600 dark:hover:bg-amber-500",
      },
      size: {
        ...
        "icon-sm": "h-9 w-9 rounded-md [&_svg]:size-3.5 md:h-7 md:w-7",
        "icon-lg": "h-11 w-11",
      },
    },
    defaultVariants: {

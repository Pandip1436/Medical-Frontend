...
export default function NotificationsPage() {
  ...
  const handleGenerateAlerts = async () => {
    ...
    try {
      ...
      toast.success('Alerts generated and refreshed')
    } catch {
  ...
  const activeFilterCount = [typeFilter !== 'all', readFilter !== 'all'].filter(Boolean).length
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-5">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {[
          ...
          {
            label: 'Low Stock',
            value: stats.byType.LOW_STOCK.toString(),
          ...
          {
            label: 'Expiry',
            value: stats.byType.EXPIRY.toString(),
      ...
      <motion.div variants={itemVariants}>
        <DataTableFilterBar
          ...
          onClearFilters={() => { setTypeFilter('all'); setReadFilter('all') }}
        >
          <EnumSelect
            label="Type"
            value={typeFilter}
              ...
              <div className="flex flex-col items-center justify-center gap-3 py-16 text-center px-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground/60 mt-0.5">
                    Try adjusting filters or click "Generate Alerts" to scan for issues
                  </p>
                </div>
              </div>
            ) : (
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            !n.isRead && 'bg-primary/[0.03] dark:bg-primary/[0.05]'
                          )}
